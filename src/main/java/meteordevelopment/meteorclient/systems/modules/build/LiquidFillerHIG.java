...
import meteordevelopment.meteorclient.utils.build.ListMode;
...
public class LiquidFillerHIG extends Module {
    ...
    public LiquidFillerHIG() {
        super(Categories.Build, "liquid-filler-HIG", "Places blocks inside of liquid source blocks within range of you.");
    }
