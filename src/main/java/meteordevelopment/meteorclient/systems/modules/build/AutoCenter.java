package meteordevelopment.meteorclient.systems.modules.build;
...
import static meteordevelopment.meteorclient.utils.build.HIGUtils.getHighway;
...
public class AutoCenter extends Module {
    ...
    public AutoCenter() {
        super(Categories.Build, "auto-center", "Automatically centers the player so that HighwayBorers mine on axis.");
    }
