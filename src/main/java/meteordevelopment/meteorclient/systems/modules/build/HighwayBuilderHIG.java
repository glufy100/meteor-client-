...
import meteordevelopment.meteorclient.utils.build.*;
...
public class HighwayBuilderHIG extends Module {
    ...
    public HighwayBuilderHIG() {
        super(Categories.Build, "highway-builder-HIG", "Automatically builds highways.");
        runInMainMenu = true;
    }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        if (Modules.get().get(AutoEat.class).eating 
            ...
            || Modules.get().get(OffhandManager.class).isEating()) {
            input.stop();
            return;
        }
